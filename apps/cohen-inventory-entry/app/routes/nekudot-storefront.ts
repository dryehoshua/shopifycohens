  ...
  return recentLedgerPromise.then((ledger) => portalShell(`
    ...
    <div class="nk-grid">
      <section class="nk-panel nk-redeem">
        ...
        <p>Un peso de saldo equivale a un peso de descuento. El código será personal, de un solo uso y sólo funcionará con esta cuenta. El envío de $70 se paga siempre aparte.</p>
